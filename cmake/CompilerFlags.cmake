...
if(TDMD_PRECISION STREQUAL "fp64")
  target_compile_definitions(tdmd_flags INTERFACE TDMD_PRECISION_FP64=1)
else()
  target_compile_definitions(tdmd_flags INTERFACE TDMD_PRECISION_MIXED=1)
endif()
if(TDMD_DETERMINISTIC)
  target_compile_definitions(tdmd_flags INTERFACE TDMD_DETERMINISTIC=1)
endif()
if(TDMD_DETERMINISTIC_REDUCE)
  target_compile_definitions(tdmd_flags INTERFACE TDMD_DETERMINISTIC_REDUCE=1)
endif()
